...
# ==============================================================================
    ...
    with col_fc2:
        ...
        fig_air.add_vline(x=2.2, line_dash="dash", line_color="#EF4444", annotation_text="Zona Sobrecosto")
...
# ==============================================================================
    ...
    fm_ratio = (load_bod_in_kgh * 24.0) / (4050.0 * 3.5)
    
    # Inferencia XGBoost con las 37 features oficiales
    input_sim = {
        ...
        'ORP_mV': 50.0 + (sim_do - 2.0) * 45.0,
        'pH': 7.2,
        'F_M_Ratio': fm_ratio,
        'Load_Influent_BOD_kgh': load_bod_in_kgh,
        'Load_Influent_COD_kgh': (sim_q * sim_bod_in * 2.1) / 1000.0,
        'BOD_Removal_Efficiency_pct': 95.2,
        'HRT_hours': hrt_hours,
        'Hour_sin': 0.0,
        'Hour_cos': 1.0,
